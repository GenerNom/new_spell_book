...
import { applyAllFilters, applyClassFilters, applyLevelFilters, applyNameFilters } from './FilterManager'
...
const testSpell4 = {"name": "name2","source": "source2","school": "school2", "level": "spellLevel3", "ritual":true,"castingTime": "castingTime2","range": "Range2","components": "Components2","duration": "Duration2","description":"Description2","class": [ "Class2", "Class3"]}
...
describe('test filtering', () => {
    ...
    it('should apply all filters together', () => {
        const results = applyAllFilters([testSpell1, testSpell2, testSpell3, testSpell4], testSpell2.name, testSpell2.level, testSpell2.class[0])
        expect(results.length).toBe(1)

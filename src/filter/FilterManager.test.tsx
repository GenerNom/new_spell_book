...
import { applyAllFilters, applyClassFilters, applyLevelFilters, applyNameFilters, applyRitualFilters } from './FilterManager'
...
describe('test filtering', () => {
    ...
    it('should apply all filters together', () => {
        const results = applyAllFilters([testSpell1, testSpell2, testSpell3, testSpell4], testSpell2.name, testSpell2.level, testSpell2.class[0], true)
        expect(results.length).toBe(1)
